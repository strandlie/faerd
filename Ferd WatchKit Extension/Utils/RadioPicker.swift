...
struct RadioPicker: View {
    ...
    var body: some View {
        ForEach(options, id: \.self) { option in
            RadioOption(option: option, currentlySelected: self.$currentlySelected, optionName: LocalizedStringKey(option.rawValue))
...
private struct RadioOption: View {
    var option: FirstScreenSelection
    @Binding var currentlySelected: FirstScreenSelection
    
    // MARK: Localization
    var optionName: LocalizedStringKey
